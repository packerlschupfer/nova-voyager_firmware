...
**Date:** 2026-01-30
**Status:** SUPERSEDED — all issues solved in lcd_research (2026-02/03)
**Conclusion (original):** Graphics capable but requires deep reverse engineering
**Conclusion (updated):** Graphics fully working. The "deep RE" was done and took
~20 hours. All issues in this doc (garbled icons, vertical stripes, watchdog
resets) are explained by: (1) writing 1 byte per X instead of 2, (2) XOR
artifacts from unfilled DDRAM, (3) missing sticky G-bit clear on mode exit.
See `lcd_research/LCD_COMMAND_REFERENCE.md` for the complete solution.
