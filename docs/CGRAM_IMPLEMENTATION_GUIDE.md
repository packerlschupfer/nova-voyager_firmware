...
**Date:** 2026-01-30 (updated 2026-05-25)
**Status:** CONFIRMED WORKING — in production use (load bar on row 3)
**CGRAM verified:** 2026-05-25 via lcd_research systematic testing
...
void lcd_define_char(uint8_t code, const uint8_t *pattern) {
    ...
    // Return to visible DDRAM — 0x80 is off-screen on this controller!
    // Visible rows: 0xC0 (row 0), 0xD0 (row 1), 0xC8 (row 2), 0xD8 (row 3)
    lcd_set_cursor(0, 0);  // or lcd_cmd(0xC0)
}
